...
User.create(name: "Endy", email: "user@user.com", password: "password", education: "First Grade", image: "https://i.imgur.com/Zhl3OLz.jpg", industry: industries.sample, city: "London")
